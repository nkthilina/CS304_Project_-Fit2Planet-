          ...
          <div className="row g-5">
            <div className="col-md-4 text-center">
              <div className=" border-1 rounded-3 bg-light p-4">
                <h4 className="py-3">
                  SEARCH <span className="text-orange">HERE</span>
                </h4>
                ...
                <div className="sider-bar">
                  ...
                  <div className="single-gd mb-5">
                    <h4>
                      Product <span className="text-orange">Categories</span>
                    </h4>
                  ...
                  <div className="single-gd mb-5">
                    <h4>
                      Filter by <span className="text-orange">Price</span>
                    </h4>
                  ...
                  <div className="single-gd left-side mb-5">
                    ...
                    <div>
                      <ul className="list-inline">
                        ...
                        <li className="list-inline-item m-0">
                          {" "}
                          <span className="text-orange">5.0</span>{" "}
                        </li>
                      </ul>
                      <ul className="list-inline">
                        <li className="list-inline-item m-0">
