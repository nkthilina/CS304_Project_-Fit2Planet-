                ...
                <div className="col-lg-7 text-center px-5">
                  ...
                  <section class="py-3">
                    <div class="row text-center text-light mb-1">
                      <div class="col-3 text-primary ">Below 18</div>
                      <div class="col-3 text-success">18 - 25</div>
                      <div class="col-3 text-warning">25 - 30</div>
                      <div class="col-3 text-danger">Over 30</div>
                    </div>
                    <div class="row text-center text-light">
                      <div class="col-3 bg-primary p-2 rounded-start">
                        UnderWeight
                      </div>
                      <div class="col-3 bg-success p-2">NormalWeight</div>
                      <div class="col-3 bg-warning p-2">OverWeight</div>
                      <div class="col-3 bg-danger p-2 rounded-end">Obese</div>
                    </div>
                  </section>
                </div>
              </div>
