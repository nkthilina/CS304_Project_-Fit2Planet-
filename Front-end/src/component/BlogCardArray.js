...
const BlogCard = () => {
  return (
    <div className="d-flex flex-wrap">
      {Data.map(({ id, image, like, disLike, update, title, description }) => (
          ...
          <div className="card rounded-6 shadow-sm">
            ...
            <div className="card-body py-0">
              ...
              <div className="d-flex justify-content-between pb-0">
                ...
                <p className="card-text">
                  {" "}
                  <small className="text-muted ovel">{update}</small>
                  <small className="text-muted ovel">mins ago</small>
                </p>
              </div>
              </div>
              <h5 className="card-title pb-2"><a href="./Post">{title}</a></h5>
              <p className="card-text pb-2">{description} </p>
            </div>
          </div>
        </div>
      ))}
