...
import YogaClasses from '../../assets/Img/Blog/Yoga.jpg';
const BlogCardYogaClasses = () => {
    return (
        <div className="col-xl-3 col-lg-4 col-md-6">
            <div className="card rounded-6 shadow-sm">
                <img src={YogaClasses} className="card-img-top rounded-t-6" alt="..." />
...
export default BlogCardYogaClasses